...
rChart <- rCharts$new()
rChart$setLib('http://timelyportfolio.github.io/rChartsExtra/d3_horizon')
rChart$setTemplate(script = "http://timelyportfolio.github.io/rChartsExtra/d3_horizon/layouts/d3_horizon_axes.html")
